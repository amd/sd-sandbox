...
from src.StableDiffusionNitroEONNXPipelineTrigger import StableDiffusionNitroEONNXPipelineTrigger
...
if __name__ == "__main__":
    ...
    pipe_trigger = StableDiffusionNitroEONNXPipelineTrigger(
